...
--
-- Cenario 2.1 - Criar dois daemons e conectá-los. Realizar troca de mensagens entre eles.
--
...
local function linkcb(reply)
	...
	alua.send(reply.daemons[2], string.format(code, reply.daemons[1]), sendcb)
end
